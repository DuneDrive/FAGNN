...
def read_data(data_dir):
    ...
    data = Data(x=att_torch, edge_index=edge_index_torch, y=y_torch, edge_attr=edge_att_torch, pos = pseudo_torch, pheno = phenotype_torch)
...
def read_sigle_data(data_dir,filename,use_gdc =False):
    ...
    data = Data(x=att_torch, edge_index=edge_index.long(), y=y_torch, edge_attr=edge_att, pheno=phenotype_torch)
    ...
    if use_gdc:
        ...
        return edge_att.data.numpy(),edge_index.data.numpy(),att,label,num_nodes,phenotype
