...
class Data(BaseData, FeatureStore, GraphStore):
    ...
    def __init__(self, x: OptTensor = None, edge_index: OptTensor = None,
                 ...
                 pos: OptTensor = None, pheno: OptTensor = None, 
                 behav: OptTensor = None, **kwargs):
    ...
    @property
    def pheno(self) -> Any:
        return self['pheno'] if 'pheno' in self._store else None

    @property
    def behav(self) -> Any:
        return self['behav'] if 'behav' in self._store else None
